...
/* 19 */     Optional<ProviderRegistration<WhitelistService>> whitelistService = Sponge.getServiceManager().getRegistration(WhitelistService.class);
/* 20 */     whitelistService.ifPresent(service -> {
